...
namespace Zolupos.Application.Migrations
{
    ...
    [Migration("20220703074244_Add Tax and BunchSub")]
    partial class AddTaxandBunchSub
    {
            ...
            modelBuilder.Entity("Zolupos.Application.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastLogin = new DateTime(2022, 7, 3, 7, 42, 43, 780, DateTimeKind.Utc).AddTicks(7244),
            ...
            modelBuilder.Entity("Zolupos.Application.Entities.OrderedProduct", b =>
                {
                    ...
                    b.Property<float>("BunchSubTotal")
                        .HasColumnType("real");
