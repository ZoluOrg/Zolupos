...
namespace Zolupos.Application.Migrations
{
    ...
    [Migration("20220612042332_Employee_Role To string")]
    partial class Employee_RoleTostring
    {
            ...
            modelBuilder.Entity("Zolupos.Application.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EmployeeId = 1,
                            FirstName = "Sample",
                            LastLogin = new DateTime(2022, 6, 12, 4, 23, 32, 96, DateTimeKind.Utc).AddTicks(413),
