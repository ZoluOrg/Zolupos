...
namespace Zolupos.Application.Migrations
{
    ...
    [Migration("20220828140341_TransactionStatus")]
            ...
            modelBuilder.Entity("Zolupos.Application.Entities.Device", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DeviceId = 1,
                            DeviceName = "Default",
                            LastUsed = new DateTime(2022, 8, 28, 14, 3, 41, 150, DateTimeKind.Utc).AddTicks(2894),
                            RegistrationDate = new DateTime(2022, 8, 28, 14, 3, 41, 150, DateTimeKind.Utc).AddTicks(2899)
                        });
                });
            ...
            modelBuilder.Entity("Zolupos.Application.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastLogin = new DateTime(2022, 8, 28, 14, 3, 41, 150, DateTimeKind.Utc).AddTicks(2967),
